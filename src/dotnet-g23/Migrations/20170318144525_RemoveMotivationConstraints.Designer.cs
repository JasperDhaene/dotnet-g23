...
namespace dotnet_g23.Migrations
{
    ...
    [Migration("20170318144525_RemoveMotivationConstraints")]
    partial class RemoveMotivationConstraints
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("dotnet_g23.Models.Domain.Action", b =>
                {
                    ...
                    b.HasDiscriminator<string>("action_type").HasValue("action");
                });
            ...
            modelBuilder.Entity("dotnet_g23.Models.Label", b =>
                {
            ...
            modelBuilder.Entity("dotnet_g23.Models.Domain.Event", b =>
                {
                    b.HasBaseType("dotnet_g23.Models.Domain.Action");
            ...
            modelBuilder.Entity("dotnet_g23.Models.Label", b =>
                {
                    b.HasOne("dotnet_g23.Models.Domain.Company", "Company")
                        .WithOne("Label")
                        .HasForeignKey("dotnet_g23.Models.Label", "CompanyForeignKey")
                        .OnDelete(DeleteBehavior.Cascade);
